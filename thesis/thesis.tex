...
This thesis is to propose a machine learning model to estimate LODS with data that can be accquired from bedside in ICU, to save time.
...
Logistic Organ Dysfunction Score, designed by [1]\cite{10.1001/jama.1996.03540100046027} for ICU, is a organ dysfunction score system with weighted variables with the worst values in first 24h that reflect severity level within an organ system and among organ systems
