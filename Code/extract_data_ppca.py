...
model = load_model('cnn_model_ppca_2.keras')

# Step 2: Load the dataset
dataset = pd.read_csv('ppca_merged_oneline.csv')
...
for index, row in dataset.iterrows():
    ...
    processed_data = processed_data.reshape(1, 24)
...
processed_df.to_csv('cnn_processed_data_ppca.csv', index=False, header=['stay_id'] + [f'feature_{i}' for i in range(processed_df.shape[1] - 1)])
